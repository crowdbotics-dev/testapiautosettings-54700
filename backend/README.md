...
## Project Structure
    ...
    ├── testapiautosettings_54700  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_54700`
...
2. Clone this repo and `cd testapiautosettings_54700`
